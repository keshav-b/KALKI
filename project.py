...
def summaryTime():
    ...
    if request.method == 'POST':
        ...
        html = html + "<br><br> Summary Level <br><input name=\"thres\" id=\"thres\" type=\"range\" min=\"1\" max=\"101\" value=\"50\" step=\"25\"><br><br>"

        html = html + "0 &nbsp 25 &nbsp 50 &nbsp 75 &nbsp 100 <br><br>"

        html = html + "<button name=\"forwardBtn\" onclick=\"move_forward()\">Submit</button></form></body></html>"
